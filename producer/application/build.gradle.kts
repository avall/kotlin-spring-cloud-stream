...
springBoot {
	mainClass.set("com.avall.kotlin.ms.producer.MSAttachmentApplication")
}
...
contracts {
    ...
    packageWithBaseClasses.set("com.avall.kotlin.ms.cousine.producer.apicontract")
...
//	basePackageForTests.set("com.avall.kotlin.ms.cousine.producer.application.contract")
